...
void Sdk::InitStarRail() {
  ...
  funcs_.set_field_of_view = game_assembly + 0xe6e8100;

  funcs_.set_target_frame_rate = game_assembly + 0xe6e1ff0;
  funcs_.quit = game_assembly + 0xe6e1b20;

  funcs_.set_vsync_count = game_assembly + 0xe7786a0;

  funcs_.enter = game_assembly + 0x814abb0;
  funcs_.leave = game_assembly + 0x814d860;
